...
class BayesianOptimization(ParameterInference):
    ...
    def prepare_new_batch(self, batch_index, points = None):
        """Prepare values for a new batch.
    ...
    # ======================================
    # ======================================
    # This function  was added, since there is no other way to evaluate MSE
    def evaluate_mse(self, points = 1000):
